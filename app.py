...
# CONFIGURACIÓN
# ===============================
st.set_page_config(layout="wide", page_title="España Vota 2026 · SIEG OSINT", page_icon="🗳️")
st.markdown("""
...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9, tab10, tab_hist, tab11 = st.tabs([
