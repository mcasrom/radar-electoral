...
# --- DATASET DE IMPACTOS (Estructura de Datos Independiente) ---
def get_osint_events():
    return [
        ...
        {"f": "2026-03-04", "e": "Ajuste Identidad Digital mcasrom", "i": "Informativo"}
    ]
...
def load_map():
    try:
        ...
        st.error("Error crítico: provincias.json no encontrado en /data/")
        return None
